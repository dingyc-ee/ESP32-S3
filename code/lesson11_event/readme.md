...
ESP32系统默认的sys_evt任务产生事件。通常的做法是，把事件转移到app_task任务中处理。

这样做的好处：  
* 可以防止长时间阻塞系统任务
* 避免在系统任务中调用复杂的函数，可能导致系统任务爆栈
...
![事件转任务执行结果](https://ding-aliyun.oss-cn-shenzhen.aliyuncs.com/esp32/section11_event_loop_to_task.jpg)